...
COMMENT ON DATABASE uvv
    IS 'Banco de Dados para aplicação do Pset 1';
...
-- Adicionando restrições p/ tabela localizações
...
-- Adicionando restrições p/ tabela departamentos
...
-- Adicionando restrições p/ tabela empregados
...
-- Adicionando restrições p/ tabela cargos
...
-- Adicionando restrições p/ tabela histórico_cargos
...
INSERT INTO empregados (id_empregados, nome, email,telefone, data_contratacao, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(100, 'Steven King', 'SKING', '515.123.4567', '2003-06-17', 'AD_PRES', 24000, null, null, 90);
INSERT INTO empregados (id_empregados, nome, email,
