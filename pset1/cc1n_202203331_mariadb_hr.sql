-- deletando o banco de dados caso existit
...
*/
-- Criação das chaves primárias das tabelas
...
alter table paises add constraint fk_paises_regioes foreign key (id_regiao) 
references regioes(id_regiao);
alter table localizacoes add constraint fk_localizacoes_pases foreign key (id_pais) 
references paises(id_pais);
alter table departamentos add constraint fk_departamentos_localizacoes foreign key (id_localizacao) 
references localizacoes(id_localizacao);
alter table departamentos add constraint fk_departamentos_empregados foreign key (id_gerente) 
references empregados(id_empregados);
alter table empregados add constraint fk_empregados_cargos foreign key (id_cargo) 
references cargos(id_cargo);
alter table empregados add constraint fk_empregados_departamento foreign key (id_departamento) 
references departamentos(id_departamentos);
alter table empregados add constraint fk_empregados_surpevisor foreign key (id_supervisor) 
references empregados(id_empregados);
alter table historico_cargos add constraint fk_historico_cargos_empregados foreign key (id_empregado) 
references empregados(id_empregados);
alter table historico_cargos add constraint fk_historico_cargos_departamento foreign key (id_departamento) 
references departamentos(id_departamentos);
alter table historico_cargos add constraint fk_historico_cargos_cargos foreign key (id_cargo) 
references cargos(id_cargo);
...
-- Criação das validações para os campos
