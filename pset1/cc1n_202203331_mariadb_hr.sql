...
-- dados todas as permissões para o usuário
...
alter table regioes add constraint un_regioes unique (nome);

-- Adicionando restrições p/ tabela países
alter table paises add constraint pk_paises primary key (id_pais);
alter table paises add constraint un_paises unique (nome);
...
alter table departamentos add constraint un_departamentos unique (nome);
...
alter table empregados add constraint un_empregados unique (email);
...
alter table cargos add constraint un_cargos unique (cargo);
