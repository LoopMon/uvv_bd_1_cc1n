-- criando usuário
create user lucas with superuser password '1234';
\echo 'Usuario criado: Lucas'
-- usar usuário lucas
alter user lucas;
\echo 'Escolhendo usuario: Lucas'
-- excluir estrutura do banco de dados caso exista
...
IS 'Banco de dados que vai armazenar as tabelas do projeto de Recursos Humanos';
\echo 'Criando banco de dados: uvv'
...
-- criar schema hr
create schema hr authorization lucas;
...
comment on table regioes is 'tabela onde guarda o nome de cada região';
comment on column regioes.id_regiao is 'identificação da região';
...
\echo 'Criando tabela paises'
-- comentários da tabela países
comment on table paises is 'tabela onde guarda o nome dos países de cada região';
comment on column paises.id_pais is 'identificação do pais';
comment on column paises.nome is 'nome do país';
comment on column paises.id_regiao is 'identificação da região que está o país';
...
\echo 'Criando tabela localizacoes'
-- comentários da tabela localizações
comment on table localizacoes is 'tabela que guarda os endereços de um país';
comment on column localizacoes.id_localizacao is 'identificação do endereço';
comment on column localizacoes.endereco is 'endereço complento';
comment on column localizacoes.cep is 'cep da cidade';
comment on column localizacoes.cidade is 'nome da cidade';
comment on column localizacoes.uf is 'Unidade federal que esta localizado';
comment on column localizacoes.id_pais is 'identifica os país que esta localização se encontra';
...
comment on table departamentos is 'tabela que guarda os dados dos departamentos';
comment on column departamentos.id_departamentos is 'identificação do departamento';
comment on column departamentos.nome is 'nome do departamento';
comment on column departamentos.id_localizacao is 'identifica o endereço do departamento';
comment on column departamentos.id_gerente is 'identifica o gerente do departamento';
...
comment on table empregados is 'tabela que guarda os dados do funcionário';
comment on column empregados.id_empregados is 'identificação do funcionário';
comment on column empregados.nome is 'nome completo do funcionário';
comment on column empregados.email is 'endereço eletrónico do funcionário';
comment on column empregados.telefone is 'número de telefone do funcionário';
comment on column empregados.data_contratacao is 'data que o funcionário entrou na empresa';
comment on column empregados.id_cargo is 'identificação do cargo que o funcionário possui';
comment on column empregados.salario is 'valor que o funcionário recebe';
comment on column empregados.comissao is 'percentual de comissão para empregados que estiverem no departamento de vendas';
comment on column empregados.id_departamento is 'identificação do departamento que o funcionário trabalha';
comment on column empregados.id_supervisor is 'indica a hierarquia entre os funcionários';
...
comment on table cargos is 'tabela que guarda os cargos da empresa';
comment on column cargos.id_cargo is 'identificação do cargo';
comment on column cargos.cargo is 'nome do cargo';
comment on column cargos.salario_minimo is 'valor minimo que o funcionário pode receber no cargo';
comment on column cargos.salario_maximo is 'valor maximo que o funcionário pode receber no cargo';

-- tabela histório de cargos
...
\echo 'Criando tabela historico_cargos'
-- comentários da tabela histórico de cargos
comment on table historico_cargos is 'tabela que guarda a transição do funcionário quando este muda de cargo ou departamento';
comment on column historico_cargos.id_empregado is 'chave primária';
comment on column historico_cargos.data_inicial is 'data de contratação do funcionário';
comment on column historico_cargos.data_final is 'data de saída do funcionário';
comment on column historico_cargos.id_departamento is 'departamento que o funcionário atuou';
comment on column historico_cargos.id_cargo is 'cargo do funcionário no departamento';


/*
	================= RESTRIÇÕES PARA AS TABELAS =================
*/
-- Adicionando as chaves primárias das tabelas
alter table regioes add constraint pk_regioes primary key (id_regiao);
alter table paises add constraint pk_paises primary key (id_pais);
alter table localizacoes add constraint pk_localizacoes primary key (id_localizacao);
alter table departamentos add constraint pk_departamentos primary key (id_departamentos);
alter table empregados add constraint pk_empregados primary key (id_empregados);
alter table cargos add constraint pk_cargos primary key (id_cargo);
alter table historico_cargos add constraint pk_historico_cargos primary key (id_empregado);
\echo 'Criando chaves primarias'

-- Adicionando as chaves estrangeiras
alter table paises add constraint fk_paises_regioes foreign key (id_regiao) references regioes(id_regiao);
alter table localizacoes add constraint fk_localizacoes_pases foreign key (id_pais) references paises(id_pais);
alter table departamentos add constraint fk_departamentos_localizacoes foreign key (id_localizacao) references localizacoes(id_localizacao);
alter table departamentos add constraint fk_departamentos_empregados foreign key (id_gerente) references empregados(id_empregados);
alter table empregados add constraint fk_empregados_cargos foreign key (id_cargo) references cargos(id_cargo);
alter table empregados add constraint fk_empregados_departamento foreign key (id_departamento) references departamentos(id_departamentos);
alter table empregados add constraint fk_empregados_surpevisor foreign key (id_supervisor) references empregados(id_empregados);
alter table historico_cargos add constraint fk_historico_cargos_empregados foreign key (id_empregado) references empregados(id_empregados);
alter table historico_cargos add constraint fk_historico_cargos_departamento foreign key (id_departamento) references departamentos(id_departamentos);
alter table historico_cargos add constraint fk_historico_cargos_cargos foreign key (id_cargo) references cargos(id_cargo);
\echo 'Criando chaves estrangeiras'

-- Adicionando check para validação dos campos
alter table empregados add constraint check_salario check(salario > 0);
alter table cargos add constraint check_cargos_salario_min check(salario_minimo > 0);
alter table cargos add constraint check_cargos_salario_max check(salario_maximo > 0);
alter table cargos add constraint check_cargos_salario check(salario_minimo < salario_maximo);
\echo 'Adicionando validacoes nos campos'

-- Adicionando as uniques
create unique index un_idx_regioes on regioes (nome);
create unique index un_idx_paises on paises (nome);
create unique index un_idx_departamentos on departamentos (nome);
create unique index un_idx_empregados on empregados (email);
create unique index un_idx_cargos on cargos (cargo);
\echo 'Criando unique index'

/*
	================= INSERINDO DADOS NAS TABELAS =================
*/
-- Inserindo dados p/ tabela regiões
...
\echo 'Preenchendo a tabela regioes'

-- Inserindo dados p/ tabela países
...
\echo 'Preenchendo tabela paises'

-- Inserindo dados p/ tabela localizações
...
\echo 'Preenchendo tabela localizacoes'

-- Inserindo dados p/ tabela cargos
...
\echo 'Preenchendo tabela cargos'

-- Inserindo dados p/ tabela departamentos
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (10, 'Administration' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (20, 'Marketing' , '1800', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (30, 'Purchasing' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (40, 'Human Resources' , '2400', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (50, 'Shipping' , '1500', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (60, 'IT' , '1400', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (70, 'Public Relations' , '2700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (80, 'Sales' , '2500', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (90, 'Executive' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (100, 'Finance' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (110, 'Accounting' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (120, 'Treasury' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (130, 'Corporate Tax' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (140, 'Control And Credit' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (150, 'Shareholder Services' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (160, 'Benefits' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (170, 'Manufacturing' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (180, 'Construction' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (190, 'Contracting' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (200, 'Operations' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (210, 'IT Support' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (220, 'NOC' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (230, 'IT Helpdesk' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (240, 'Government Sales' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (250, 'Retail Sales' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (260, 'Recruiting' , '1700', null);
INSERT INTO departamentos(id_departamentos, nome, id_localizacao, id_gerente) VALUES (270, 'Payroll' , '1700', null);
\echo 'Preenchendo tabela departamentos'

-- Inserindo dados p/ tabela empregados
INSERT INTO empregados (id_empregados, nome, email, telefone, data_contratacao, id_cargo, salario, comissao, id_supervisor, id_departamento) 
...
\echo 'Preenchendo a tabela empregados'

-- Inserindo dados p/ tabela histórico_cargos
...
\echo 'Preenchendo a tabela historico_cargos'

/*
	================= ATUALIZANDO AS TABELAS =================
*/
-- Adicionando gerente para alguns departamentos
update departamentos set id_gerente = 200 where id_departamentos = 10;
update departamentos set id_gerente = 201 where id_departamentos = 20;
update departamentos set id_gerente = 114 where id_departamentos = 30;
update departamentos set id_gerente = 203 where id_departamentos = 40;
update departamentos set id_gerente = 121 where id_departamentos = 50;
update departamentos set id_gerente = 103 where id_departamentos = 60;
update departamentos set id_gerente = 204 where id_departamentos = 70;
update departamentos set id_gerente = 145 where id_departamentos = 80;
update departamentos set id_gerente = 100 where id_departamentos = 90;
update departamentos set id_gerente = 108 where id_departamentos = 100;
update departamentos set id_gerente = 205 where id_departamentos = 110;
\echo 'Adicionando gerentes aos departamentos'
